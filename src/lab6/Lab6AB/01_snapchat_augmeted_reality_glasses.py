...
video_capture = cv2.VideoCapture("MultiViewExampleCreatest.mp4")

while video_capture.isOpened(): #True:

    # Comentar cuando se use una imagen estatica como fuente
    # Capture frame from the VideoCapture object:
    ret, frame = video_capture.read()

    # Descomentar para una imagen estatica como fuente
