...
plt.suptitle("ORB + Brute-Force (BF) matcher", fontsize=14, fontweight='bold')
fig.patch.set_facecolor('silver')

# Load the 'query' and 'scene' image:
image_query = cv2.imread('img/maniqui_bandera_2.JPG')#('opencv_logo_with_text.png')
image_scene = cv2.imread('img/maniqui_1_rot.JPG')    #('opencv_logo_with_text_scene.png')
...
# Plot the images:
show_img_with_matplotlib(result, "Correspondencias entre Imágenes", 1)

plt.savefig("src/lab5/out/MatchingResults.png", dpi=600)
