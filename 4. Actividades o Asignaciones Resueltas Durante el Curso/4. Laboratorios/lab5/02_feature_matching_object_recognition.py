...
image_query = cv2.imread('img/kylo_9.JPG')   #('opencv_logo_with_text.png')
image_scene = cv2.imread('img/pts_5.JPG')    #('opencv_logo_with_text_scene.png')

# Create the dimensions of the figure and set title:
fig = plt.figure(figsize=(14, 5))
plt.suptitle("Emparejamiento y calculo de Homografía  para reconocimiento de objetos", fontsize=14, fontweight='bold')
...
# Plot the images:
show_img_with_matplotlib(img_obj, "Objeto Detectado", 1)
show_img_with_matplotlib(img_matching, "Correspondencias", 2)

plt.savefig("src/lab5/out/ObjectDetectionResults.png", dpi=600)
