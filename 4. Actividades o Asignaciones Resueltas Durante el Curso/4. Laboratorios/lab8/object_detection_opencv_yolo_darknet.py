...
# Load input image:
image = cv2.imread("object_detection_test_image.png") #object_detection_test_image.png collage2.jpg
(H, W) = image.shape[:2]

# Get the output layer names:
layer_names = net.getLayerNames()
layer_names = [layer_names[i - 1] for i in net.getUnconnectedOutLayers()]   #[0]
